...
export const FloatingButton = () => {
    const WaLink = "https://api.whatsapp.com/send?phone=628113705565"
        ...
        <>
            <div className="fixed bottom-15 md:bottom-5 right-4 md:right-5 z-[100]">
                <section className="flex flex-col gap-2 md:gap-3 duration-300">
                    <button
                        onClick={scrollToTop}
                        className={`${isVisible ? "scale-100 " : 'scale-0 translate-x-full'} bg-darkColor bg-main/50 duration-300 backdrop-blur-md hover:bg-main hover:text-baseColor dark:text-white text-otherMuted rounded-full p-2 md:p-4 shadow-lg`}
                    >
